...
Gem::Specification.new do |spec|
  ...
  spec.metadata = {
    ...
    "changelog_uri" =>
      "https://github.com/RailsEventStore/rails_event_store/blob/master/contrib/ruby_event_store-rom/CHANGELOG.md",
  ...
  spec.add_dependency "ruby_event_store", ">= 2.0.0", "< 4.0.0"
end
