::Sequel.migration do
  up do
    ...
    create_table :event_store_events do
      ...
      column :created_at, DateTime, null: false, type: "TIMESTAMP", index: "index_event_store_events_on_created_at"
      column :valid_at, DateTime, null: false, type: "TIMESTAMP", index: "index_event_store_events_on_valid_at"
