...
module RubyEventStore
  module Browser
    class Layout
      def initialize(stylesheets_resolver, scripts_resolver, nav_links_resolver, views_root: Renderer::VIEWS_ROOT)
      ...
      def with_views_root(views_root)
        Layout.new(@stylesheets_resolver, @scripts_resolver, @nav_links_resolver, views_root: views_root)
      end
      ...
      def renderer
        Renderer.new([@views_root, Renderer::VIEWS_ROOT])
      end
