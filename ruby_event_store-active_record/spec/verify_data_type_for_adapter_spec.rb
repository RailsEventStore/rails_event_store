  ...
  module ActiveRecord
    ::RSpec.describe VerifyDataTypeForAdapter do
      ...
      specify "MySQL doesn't support jsonb" do
        expect { VerifyDataTypeForAdapter.new.call("MySQL2", "jsonb") }.to raise_error InvalidDataTypeForAdapter,
      ...
      specify "PostgreSQL doesn't support bla" do
        expect { VerifyDataTypeForAdapter.new.call("PostgreSQL", "bla") }.to raise_error InvalidDataTypeForAdapter,
      ...
      specify "sqlite doesn't support json" do
        expect { VerifyDataTypeForAdapter.new.call("SQLite", "json") }.to raise_error InvalidDataTypeForAdapter,
                    "sqlite doesn't support json"
      end

      specify "sqlite doesn't support jsonb" do
        expect { VerifyDataTypeForAdapter.new.call("SQLite", "jsonb") }.to raise_error InvalidDataTypeForAdapter,
