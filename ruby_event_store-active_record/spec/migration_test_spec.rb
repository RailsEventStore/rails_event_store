      ...
      specify "postgres" do
        ...
        expect(pg_schema("event_store_events").gsub(/\s+/, " ")).to eq <<~SCHEMA.strip.gsub(/\s+/, " ")
          ...
          Indexes:
              ...
              "index_event_store_events_on_as_of" btree (COALESCE(valid_at, created_at))
        ...
        expect(pg_schema("event_store_events_in_streams").gsub(/\s+/, " ")).to eq <<~SCHEMA.strip.gsub(/\s+/, " ")
          ...
          Indexes:
              ...
              "index_event_store_events_in_streams_on_stream_c_collation" btree (stream COLLATE "C")
      ...
      specify "mysql" do
        ...
        expect(mysql_schema("event_store_events_in_streams")).to eq <<~SCHEMA.strip
          CREATE TABLE `event_store_events_in_streams` (
            ...
            KEY `index_event_store_events_in_streams_on_stream_and_id` (`stream`,`id`),
