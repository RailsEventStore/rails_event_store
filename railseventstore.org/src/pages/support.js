        ...
        <div className="max-w-5xl  text-balance px-4 mx-auto divide-y divide-gray-200  dark:divide-gray-800 lg:px-8 xl:px-12 divide-solid *:!border-x-0 *:py-12">
          <div className="flex flex-wrap ">
            <div className="w-full text-2xl font-bold sm:w-2/5">
              <h2 className="mb-1.5">Community Help</h2>
          ...
          <div className="flex flex-wrap">
            <div className="w-full text-2xl font-bold sm:w-2/5">
              <h2 className="mb-1.5">Domain-Driven Rails</h2>
              <span className="block text-base font-bold text-gray-500 uppercase">
                Starting from $49
              </span>
            </div>
          ...
          <div className="flex flex-wrap">
            <div className="w-full text-2xl font-bold sm:w-2/5">
              <h2 className="mb-1.5">Arkademy Subscription</h2>
              <span className="block text-base font-bold text-gray-500 uppercase">
                $49 / month
              </span>
            </div>
          ...
          <div className="flex flex-wrap">
            <div className="w-full text-2xl font-bold sm:w-2/5">
              <h2 className="mb-1.5">Rails Event Store Mentoring</h2>
              <span className="block text-base font-bold text-gray-500 uppercase">
                $2,000 / month
              </span>
            </div>
          ...
          <div className="flex flex-wrap">
            <div className="w-full text-2xl font-bold sm:w-2/5">
              <h2 className="mb-1.5">Custom Feature Development</h2>
              <span className="block text-base font-bold text-gray-500 uppercase">
                Ask for quote
              </span>
            </div>
          ...
          <div className="flex flex-wrap">
            <div className="w-full text-2xl font-bold sm:w-2/5">
              <h2 className="mb-1.5">One-shot Help</h2>
              <span className="block text-base font-bold text-gray-500 uppercase">
                Ask for quote
              </span>
            </div>
          ...
          <div className="flex flex-wrap">
            <div className="w-full text-2xl font-bold sm:w-2/5">
              <h2 className="mb-1.5">Legacy Rails/DDD Mentoring</h2>
              <span className="block text-base font-bold text-gray-500 uppercase">
                Ask for quote
              </span>
            </div>
          ...
          <div className="flex flex-wrap">
            <div className="w-full text-2xl font-bold sm:w-2/5">
              <h2 className="leading-tight">From Event Storming to an App</h2>
              <span className="block text-base font-bold text-gray-500 uppercase">
                Ask for quote
              </span>
            </div>
          ...
          <div className="flex flex-wrap">
            <div className="w-full text-2xl font-bold sm:w-2/5">
              <h2 className="mb-1.5">Rails DDD Workshop</h2>
              <span className="block text-base font-bold text-gray-500 uppercase">
                Ask for quote
              </span>
            </div>
          ...
          <div className="flex flex-wrap">
            <div className="w-full text-2xl font-bold sm:w-2/5">
              <h2 className="mb-1.5">Full time help from Arkency</h2>
              <span className="block text-base font-bold text-gray-500 uppercase">
                Ask for quote
              </span>
            </div>
