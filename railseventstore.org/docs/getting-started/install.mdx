...
<AsciinemaWidget
  src="https://asciinema.org/a/554180.js"
  id="asciicast-554180"
/>
...
<div className="px-4 text-blue-600 bg-blue-100 border-l-4 border-blue-500" role="alert">
  ...
  <p className="inline-block text-base">Make sure to check generated <code className="bg-transparent">config/initializers/rails_event_store.rb</code> for initial configuration.</p>
</div>
