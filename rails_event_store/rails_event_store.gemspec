...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'ruby_event_store-browser', '= 0.35.0'
  spec.add_dependency 'rails_event_store_active_record', '= 0.35.0'
  spec.add_dependency 'aggregate_root', '= 0.35.0'
  spec.add_dependency 'bounded_context', '= 0.35.0'
