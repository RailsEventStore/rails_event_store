...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "ruby_event_store", "= 2.19.2"
  spec.add_dependency "ruby_event_store-browser", "= 2.19.2"
  spec.add_dependency "rails_event_store_active_record", "= 2.19.2"
  spec.add_dependency "aggregate_root", "= 2.19.2"
