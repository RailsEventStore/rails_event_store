...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "ruby_event_store", "= 3.1.0"
  spec.add_dependency "ruby_event_store-browser", "= 3.1.0"
  spec.add_dependency "ruby_event_store-active_record", "= 3.1.0"
  spec.add_dependency "aggregate_root", "= 3.1.0"
