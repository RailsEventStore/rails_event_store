...
module RubyEventStore
  RSpec.describe Client do
    ...
    it 'allows to provide a custom dispatcher' do
      ...
      serialized_record1 = Mappers::NullMapper.new.event_to_serialized_record(event1)
      ...
      expect(dispatcher.dispatched).to eq([{subscriber: handler, event: event1, serialized_record:serialized_record1}])
    end
